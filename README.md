...
3. Paste the UPM branch URL and press enter:
    - `https://github.com/Uralstech/AvLoader.git#upm`

### GitHub Clone

1. Clone or download the repository from the desired branch (main, preview/unstable)
2. Drag the package folder `AvLoader/AvLoader/Packages/com.uralstech.avloader` into your Unity project's `Packages` folder
